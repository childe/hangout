...
public interface SinkCounterMBean {
  ...
  long getConsumerOfKafkaCount();

  long incrementConsumerOfKafkaCount();

  long getConsumerOfKafkaException();

  long incrementConsumerOfKafkaException();

  long getWriteDataToEsCount();

  long incrementWriteDataToEsCount();

  long getWriteDataToEsException();

  long incrementWriteDataToEsException();
