...
public class LogSetter {
    ...
    public void initLogger(CommandLineValues cmdLine) {
        ...
        String logPath = System.getenv("basedir")+"/logs/jlogstash.log";
    ...
    private static void setLogger(CommandLineValues cmdLine, WriterAppender appender, org.apache.log4j.Logger logger) {
